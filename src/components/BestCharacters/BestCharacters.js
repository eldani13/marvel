            ...
            <div className="best-characters">
                <Grid columns={2} divided="vertically">
                    <Grid.Column>
                        ...
                        <Button 
                             as="a"
                             href="https://www.xataka.com/cine-y-tv/hay-98-peliculas-series-basadas-personajes-marvel-estas-todas-plataformas-donde-puedes-verlas"
                             target="_blank"
                             
                        >Ver todos los personajes</Button>
                    </Grid.Column>
